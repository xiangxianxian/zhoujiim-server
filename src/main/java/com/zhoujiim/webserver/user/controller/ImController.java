...
import com.zhoujiim.server.model.MessageWrapper;
import com.zhoujiim.server.model.proto.MessageBodyProto;
import com.zhoujiim.server.model.proto.MessageProto;
import com.zhoujiim.server.proxy.MessageProxy;
import com.zhoujiim.server.session.SessionManager;
import com.zhoujiim.webserver.base.controller.BaseController;
import com.zhoujiim.webserver.dwrmanage.DwrUtil;
import com.zhoujiim.webserver.dwrmanage.connertor.DwrConnertor;
import com.zhoujiim.webserver.sys.service.FilesInfoService;
import com.zhoujiim.webserver.user.model.ImFriendUserData;
import com.zhoujiim.webserver.user.model.ImFriendUserInfoData;
import com.zhoujiim.webserver.user.model.ImGroupUserData;
import com.zhoujiim.webserver.user.model.ImUserData;
...
import com.zhoujiim.webserver.user.service.UserDepartmentService;
import com.zhoujiim.webserver.user.service.UserMessageService;
import com.zhoujiim.webserver.util.Pager;
	...
	public String login(@RequestParam Map<String, Object> params,HttpServletRequest request){
		...
		if(userAccount!=null){
			...
			if(!StringUtils.isEmpty(iostoken)) {
				userAccount.setIostoken(iostoken);
				userAccountServiceImpl.update(userAccount);
			}
