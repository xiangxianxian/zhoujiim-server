	    		...
	    		<div class="layui-form-item">
				 ...
				 <div class="layui-form-item">
				    <div class="layui-input-block">
				     ...
				     <button type="button"  class="layui-btn layui-btn-primary showform" >注册</button>
				    </div>
				  </div>
	    </form>
	  </div>
...
window.onload=function(){
	var c=localStorage.getItem("account_");
	var p=localStorage.getItem("password_");
	if(c && p){
		location.href="login?account="+c+"&password="+p ;
		return false;
	}
}
layui.use(['form'], function(){
  ...
  form.on('submit(login)', function(data){
	   /*  layer.alert(JSON.stringify(data.field), {
	    ...
	    var account_=data.field.account;
	    var password_=data.field.password;
	    location.href="login?account="+account_+"&password="+password_;
	    localStorage.setItem("account_",account_);
