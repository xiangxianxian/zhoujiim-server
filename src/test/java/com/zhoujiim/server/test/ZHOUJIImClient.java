...
public class ZHOUJIImClient {

    public  String host = "10.10.43.109";
    ...
    public   Bootstrap getBootstrap() {
        ...
        b.handler(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel ch) throws Exception {
                ...
                pipeline.addLast("handler", new ZHOUJIImClientHandler());
            }
        });
        return b;
    }
    ...
    public static void main(String[] args) throws Exception {
    	 try {
    		 ...
    		 //链接socket服务
             new ZHOUJIImClient().connect(new MessageData().generateConnect(currentuser));
             ...
             while (true) { 
                     ...
                     new ZHOUJIImClient().connect(new MessageData().generateSend(currentuser, reuser,line));
